from PyQt5.QtWidgets import QApplication, QWidget, QVBoxLayout, QHBoxLayout, QLabel, QLineEdit, QPushButton, QTableWidget, QTableWidgetItem, QGroupBox, QSpacerItem, QSizePolicy, QScrollArea
...
class DetailHewanPage(QWidget):
    ...
    def initUI(self):
        ...
        main_content_layout.setContentsMargins(int(screen_geometry.width() * 0.25), int(screen_geometry.height() * 0.05), int(screen_geometry.width() * 0.25), 0)
        ...
        animal_image_label.setPixmap(QPixmap('meng.png').scaled(int(screen_geometry.width() * 0.33), int(screen_geometry.height()), Qt.KeepAspectRatio))
